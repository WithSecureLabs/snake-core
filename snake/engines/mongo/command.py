...
class CommandCollection:
    ...
    def clean(self):
        ...
        for document in documents:
            self.db.commands.update_one(
                {"_id": document["_id"]}, {"$set": {"status": enums.Status.FAILED}}
            )
    ...
    def delete(self, sha256_digest, scale, command, args):
        ...
        """
        return self.db.commands.delete_many(
            {
    ...
    def select(self, sha256_digest, scale, command, args):
        ...
        """
        return self.db.commands.find_one(
            {
                "sha256_digest": sha256_digest,
                "scale": scale,
                "command": command,
    ...
    def update(self, sha256_digest, scale, command, args, data):
        ...
        """
        return self.db.commands.update_one(
            {
                "sha256_digest": sha256_digest,
                "scale": scale,
                "command": command,
...
class AsyncCommandCollection:
    ...
    def delete(self, sha256_digest, scale, command, args, callback=None):
        ...
        """
        future = self.db.commands.delete_many(
            {
                "sha256_digest": sha256_digest,
                "scale": scale,
                "command": command,
    ...
    def select(self, sha256_digest, scale=None, command=None, args=None, callback=None):
        ...
        Returns:
            :obj:`CommandSchema`: The selected command.
        """
        future = self.db.commands.find_one(
            {
                "sha256_digest": sha256_digest,
                "scale": scale,
                "command": command,
    ...
    def update(
        self, sha256_digest, scale, command, args, data, callback=None
        ...
        Returns:
            :obj:`CommandSchema`: The updated command.
        """
        future = self.db.commands.update_one(
            {
                "sha256_digest": sha256_digest,
                "scale": scale,
                "command": command,
    ...
    def replace(
        ...
        """
        future = self.db.commands.replace_one(
            {
                "sha256_digest": sha256_digest,
                "scale": scale,
                "command": command,
